...
define('IVN_CSS_DIR', trailingslashit(IVN_THEME_DIR . 'assets/css'));
define('IVN_CSS_URI', trailingslashit(IVN_THEME_URI . 'assets/css'));

define('IVN_IMG_DIR', trailingslashit(IVN_THEME_DIR . 'assets/img'));
define('IVN_IMG_URI', trailingslashit(IVN_THEME_URI . 'assets/img'));

define('IVN_INC_DIR', trailingslashit(IVN_THEME_DIR . 'includes'));
define('IVN_INC_URI', trailingslashit(IVN_THEME_URI . 'includes'));

define('IVN_JS_DIR', trailingslashit(IVN_THEME_DIR . 'assets/js'));
define('IVN_JS_URI', trailingslashit(IVN_THEME_URI . 'assets/js'));
