...
function ivn_admin_js()
{
    ...
    /**
     * Enqueue and localize main scripts.
     */
    wp_enqueue_script('ivn-admin', IVN_JS_URI . $assetsMapping['admin'], array('jquery', 'jquery-ui-core', 'underscore', 'wp-color-picker'), false, true);
    wp_localize_script('ivn-admin', '_IVN', array_merge(apply_filters('ivn_localize_back_end_script', array()), array(
        'Mobile' => intval(wp_is_mobile()),
        'Ajax' => array(
            'URL' => admin_url('admin-ajax.php'),
            'Nonces' => apply_filters('ivn_nonces_back_end', array()),
        ),
    )));
}
